...
# Date              : Fri 01 Oct 2021 02:50:48
# Last Modified Date: Fri 01 Oct 2021 02:50:48
...
Metric = Literal['auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy','sensitivity', 'precision', 'recall', 'specificity', 'f1_score']
...
class TrainArgs(CommonArgs):
	...
	"""Whether to evaluate performance on the training set."""
	quiet: bool = False
	...
	aggregation: Literal['mean', 'sum', 'norm', 'self-attention', 'hier-attention', 'all-concat'] = 'mean'
