...
from chemprop.data import get_data, split_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset
...
def make_predictions(args: PredictArgs, smiles: List[List[str]] = None) -> List[List[Optional[float]]]:
	...
	# MUST CONVERT TO False for probablity predictions
	# True for embedding outputs
        model.featurizer = False
    ...
    for full_index, datapoint in enumerate(full_data):
        ...
        preds = model_preds[valid_index] if valid_index is not None else ['Invalid SMILES'] * len(task_names)
