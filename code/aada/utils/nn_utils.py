...
from aada.data import MoleculeDataLoader, MoleculeDataset
...
def compute_molecule_vectors(model: nn.Module,
    ...
    """
    Computes the molecule vectors output from the last layer of a :class:`~aada.models.MoleculeModel`.

    :param model: A :class:`~aada.models.MoleculeModel`.
