...
class MolGraph:
	...
	def __init__(self, ic, mol: Union[str, Chem.Mol]):
		"""
...
def mol2graph(ics, mols: Union[List[str], List[Chem.Mol]]) -> BatchMolGraph:
	"""
	...
	"""
	return BatchMolGraph([MolGraph(ic, mol) for ic, mol in zip(ics, mols)])
